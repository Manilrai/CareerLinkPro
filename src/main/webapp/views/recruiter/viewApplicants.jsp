    ...
    <div class="card">
        <div class="table-container">
            <table>
                <thead>
                <tr>
                    <th>#</th><th>Student Name</th><th>Email</th><th>Phone</th>
                    <th>Applied Date</th><th>Status</th><th>Update Status</th>
                </tr>
                </thead>
                <tbody>
                <%
                ...
                <tr>
                    <td><%= count++ %></td>
                    <td><strong><%= a.getFullName() %></strong></td>
                    <td><%= a.getEmail() %></td>
                    <td><%= a.getPhone() %></td>
                    ...
                    <td>
                        <form action="${pageContext.request.contextPath}/recruiter/applicants"
                            ...
                            <button type="submit" class="btn btn-primary"
                                    style="padding:0.3rem 0.8rem; font-size:0.8rem;">Update</button>
                        </form>
                    </td>
                </tr>
                <% } } else { %>
